...
public class NoteMainPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<a href=\"../solutions.notes/NoteNewnote.java\">New Note</a>");
		...
		if (currentNote == null) {
			...
			out.println("				<a href=\"../solutions.notes/NoteDelete.java\" class=\"card-link\">Delete</a>");
			out.println("  			</div>");
			out.println("		</div>");
		}
		out.println("	</div>");
